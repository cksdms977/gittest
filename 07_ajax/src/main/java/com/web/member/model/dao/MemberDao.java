...
//	여기서 public static으로 만들어 주면 어디든지 getMember 를 사용할수있음
	...
	public int enrollMmeber(Connection conn, Member m) {
		PreparedStatement pstmt = null;
		int result = 0;
//		String sql = this.sql.getProperty("enrollMember");
		try {
	...
	public Member checkId(Connection conn, String id) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Member m = null;
		String sql2=sql.getProperty("checkId");
		try {
	...
	public int updatePaswword(Connection conn, String userId, String password) {
		PreparedStatement pstmt = null;
		int result = 0;
