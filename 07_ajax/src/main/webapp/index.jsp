...
<body>
	...
	<script>
		...
		postBtn.addEventListener("click", e=>{
			...
			// post방식으로 요청을 보낼때는 해더설정을 추가로 해줘야 한다.
			...
			request.send("param="+val+"&data=asdf"); // 키 벨류 형식으로 이렇게 여러개 데이터를 보낼수 있음
		...
		sendBtn.addEventListener("click", e =>{
			...
			// 변경상태는 readySatate속성에 저장 -> 0 ~ 4까지의 값을 가짐
			// *4 : 응답이 완료된 상태
			// 응답코드를 저장하는 속성 status임 -> 404(서비스주소를 찾을수 없을때), 500(서버에러), 200(정보확인 통신)
