		...
		<header>
			...
			<c:if test="${loginmember == null }">
				...
				<c:if test="${loginmember !=null }">
					<table id="logged-in">
						...
						<tr>
							<td>
								<input type="button" value="내 정보보기" onclick="location.assign('${path}/member/selectmemberinfo.do?userId=${loginmember.userId}')">
							</td>
							<td>
			...
			<nav>
				<ul class="main-nav">
					...
					<li id="notice"><a href="${path }/admin/noticemainview.do">공지사항</a></li>
					<li id="board"><a href="${path }/board/boardList.do">게시판</a></li>
					<c:if test="${loginmember != null && loginmember.userId eq 'admin' }">
					<li id="member"><a href="${path }/admin/memberList.do">회원관리</a></li>
					</c:if>
				</ul>
			</nav>
		</header>
